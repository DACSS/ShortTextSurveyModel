...
category_key<-read.csv("category_type_coding.csv",header=T,stringsAsFactors=F) #Read in the hand-coded key of category types
...
png("C:/Users/Tim/Dropbox/Democracy Meaning/Survey Re-Analysis/Shared Open Response.png",width=8,height=5, units="in", res=300)
...
png("~/Dropbox/Democracy Meaning/Survey Re-Analysis/Shared Closed Response With Ambivalence.png",width=8,height=5, units="in", res=300)
...
dev.off()
png("~/Dropbox/Democracy Meaning/Survey Re-Analysis/Shared Closed Response No Ambivalence.png",width=8,height=5, units="in", res=300)
...
png("~/Dropbox/Democracy Meaning/Survey Re-Analysis/Closed Response Theme Consensus and Contestation.png",width=8,height=5, units="in", res=300)
